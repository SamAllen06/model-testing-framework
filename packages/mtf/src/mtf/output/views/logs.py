...
from mtf.output.events import Event
...
class LogsView(View):
    ...
    def _on_sample_generated(self, sample_index: int, sample_count: int, sample: Sample) -> None:
        self._LOGGER.info(f"Generated sample {sample_index + 1} of {sample_count}")
